...
--data_train DIV2K \
--data_test DIV2K \
--dir_data 'C:\Users\PC\Downloads\EDSR-PyTorch-master_v2\DIV2K_Fluid_Corrected' \
--ext 'img' \
--data_range '1111-1910/1911-2010' \
--loss '0.1*L1+0.1*DIV+100*GRAD' \
--lr 1e-4 \
--epochs 300 \
--batch_size 8 \
--n_threads 4 \
--save Flow_LapSRN_Wider_128_v1 \
--reset
